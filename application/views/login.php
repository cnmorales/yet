						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="<?php echo base_url()?>login_controller/usuario_agregar/" method="POST" style="display: none;">
									...
									<div class="form-group">
										<input type="email" name="Email2" id="email2" tabindex="1" class="form-control" placeholder="Confirmar email" value="">
									</div>
									<div class="form-group">
										<input type="password" name="Clave" id="password" tabindex="2" class="form-control" placeholder="Clave">
									</div>
									<div class="form-group">
										<input type="password" name="Clave2" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirmar clave">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
